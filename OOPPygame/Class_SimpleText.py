...
class SimpleText():
    ...
    def __init__(self, window, loc, value, textColor):
        ...
        self.window = window
        self.loc = loc
        self.font = pygame.font.SysFont(None, 30) # None indicates we want system font
        self.textColor = textColor
        self.text = None # so that the call to setValue below will force the creation of the text image
